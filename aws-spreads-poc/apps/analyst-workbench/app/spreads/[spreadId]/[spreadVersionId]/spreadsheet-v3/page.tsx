...
export default async function SpreadsheetV3Page({ params }: PageProps) {
  ...
  return (
    <main className="page">
      <section className="hero">
        <div className="badge accent">Spreadsheet v3 route</div>
        <h1>Spreadsheet-like grid v3 for {spreadId}</h1>
        <p className="muted">
          This route adds stronger multi-row workflows, clearer save feedback, and more spreadsheet-like editing behavior on top of the v2 foundation.
        </p>
        <div className="cards">
